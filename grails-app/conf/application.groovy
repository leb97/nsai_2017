...
//admin patterns
	...
	[pattern: '/user/update/**',         	access: ['ROLE_ADMIN']],
	...
	[pattern: '/subject/create',         	access: ['ROLE_ADMIN']],
	[pattern: '/subject/save',         		access: ['ROLE_ADMIN']],
	[pattern: '/subject/teacherIndex',      access: ['ROLE_ADMIN']],
	[pattern: '/subject/showMy/**',         access: ['ROLE_ADMIN']],
	[pattern: '/subject/delete/**',         access: ['ROLE_ADMIN']],
	[pattern: '/score/adminIndex',        	access: ['ROLE_ADMIN']],
	[pattern: '/score/showTeacher/**',      access: ['ROLE_ADMIN']],
	[pattern: '/score/delete/**',         	access: ['ROLE_ADMIN']],
	[pattern: '/score/teacherindex',        access: ['ROLE_ADMIN']],
	[pattern: '/score/create',         		access: ['ROLE_ADMIN']],
	[pattern: '/score/save',         		access: ['ROLE_ADMIN']],
	[pattern: '/user/showTeacher/**',       access: ['ROLE_ADMIN']],
	[pattern: '/user/showMy/**',         	access: ['ROLE_ADMIN']],
	[pattern: '/user/editMy/**',         	access: ['ROLE_ADMIN']],
//student patterns
